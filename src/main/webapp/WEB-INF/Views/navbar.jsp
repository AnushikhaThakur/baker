...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
  ...
  <div class="col-sm-4">
<center><img src="resources/images/newlogo.png" class="img-responsive" alt="logo" width="304" height="236"></center>
</div>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active" style="background-color:#3399FF;"><a href="home">Home</a></li>
        <li><a href="#ab">About_Us</a></li>
        <li><a href="#co">Contact_Us</a></li>
